class VendingMachine {
	...
	toCoinTable(){
		let result = `<table>`
			...
			result += `<tr> <td>Alloy</td> <td>${this.allMyCoins[0].alloy}</td> </tr>`
			result += `<tr> <td>Diameter</td> <td>${this.allMyCoins[0].diameter}</td> </tr>`
			result += `<tr> <td>Weight</td> <td>${this.allMyCoins[0].weight}</td> </tr>`
			result += `<tr> <td>Value</td> <td>${this.allMyCoins[0].value}</td> </tr>`
			result += `</table>`
